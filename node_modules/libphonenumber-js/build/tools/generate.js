...
var phone_number_types = ['premium_rate', 'toll_free', 'shared_cost', 'voip', 'personal_number', 'pager', 'uan', 'voice_mail', 'fixed_line', 'mobile']; // Excessive fields from "PhoneNumberMetadata.xml"
...
function _default(input, version, included_countries, extended, included_phone_number_types) {
  ...
  return parseStringPromisified(input).then(function (xml) {
    ...
    var _loop2 = function _loop2() {
      ...
      var country = {
        ...
        examples: get_phone_number_examples(territory) // Check that national (significant) phone number pattern
      ...
      if (territory.availableFormats) {
        ...
        for (var _iterator5 = country.formats, _isArray5 = Array.isArray(_iterator5), _i8 = 0, _iterator5 = _isArray5 ? _iterator5 : _iterator5[Symbol.iterator]();;) {
          var _ref5;
          ...
          if (format.format.indexOf(_AsYouType.DIGIT_PLACEHOLDER) >= 0) {
            throw new Error("Phone number format \"".concat(format.format, "\" contains a reserved \"").concat(_AsYouType.DIGIT_PLACEHOLDER, "\" symbol for pattern ").concat(format.pattern, " for ").concat(country_code));
          }
        }
      }
    ...
    _loop: for (var _iterator2 = xml.phoneNumberMetadata.territories[0].territory, _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _iterator2[Symbol.iterator]();;) {
      var _ref2;
    ...
    for (var _i3 = 0, _Object$keys = Object.keys(countries); _i3 < _Object$keys.length; _i3++) {
      var country_code = _Object$keys[_i3];
    ...
    for (var _i4 = 0, _Object$keys2 = Object.keys(country_calling_code_to_countries); _i4 < _Object$keys2.length; _i4++) {
      var country_calling_code = _Object$keys2[_i4];
      var country_codes = country_calling_code_to_countries[country_calling_code];

      for (var _iterator3 = country_codes, _isArray3 = Array.isArray(_iterator3), _i5 = 0, _iterator3 = _isArray3 ? _iterator3 : _iterator3[Symbol.iterator]();;) {
        var _ref3;
      ...
      for (var _iterator4 = country_codes, _isArray4 = Array.isArray(_iterator4), _i6 = 0, _iterator4 = _isArray4 ? _iterator4 : _iterator4[Symbol.iterator]();;) {
        var _ref4;
        ...
        for (var _i7 = 0, _phone_number_types = phone_number_types; _i7 < _phone_number_types.length; _i7++) {
          var _type2 = _phone_number_types[_i7];
          ...
          if (included_phone_number_types) {
            if (!included_phone_number_types.has(_type2)) {
              delete types[_type2];
            }
...
function parse_possible_lengths(possible_length_string) {
  ...
  for (var _iterator6 = possible_length_string.split(','), _isArray6 = Array.isArray(_iterator6), _i9 = 0, _iterator6 = _isArray6 ? _iterator6 : _iterator6[Symbol.iterator]();;) {
    var _ref6;
    ...
    if (length[0] === '[') {
      ...
      if (lengths.has(_i10)) {
        throw new TypeError("Duplicate length element found (".concat(_i10, ") in possibleLength string ").concat(length, "."));
      }
...
function populateNumberingPlanPossibleLengths(metadata) {
  ...
  for (var _i11 = 0, _Object$keys3 = Object.keys(types); _i11 < _Object$keys3.length; _i11++) {
    var _type = _Object$keys3[_i11];
    var type_possible_lengths = parse_possible_lengths(types[_type].possible_lengths);

    for (var _iterator8 = type_possible_lengths, _isArray8 = Array.isArray(_iterator8), _i14 = 0, _iterator8 = _isArray8 ? _iterator8 : _iterator8[Symbol.iterator]();;) {
      var _ref8;
    ...
    if (types[_type].possible_lengths_local) {
      ...
      for (var _iterator9 = type_possible_lengths_local, _isArray9 = Array.isArray(_iterator9), _i15 = 0, _iterator9 = _isArray9 ? _iterator9 : _iterator9[Symbol.iterator]();;) {
        var _ref9;
  ...
  for (var _iterator7 = possible_lengths_local, _isArray7 = Array.isArray(_iterator7), _i12 = 0, _iterator7 = _isArray7 ? _iterator7 : _iterator7[Symbol.iterator]();;) {
    var _ref7;
  ...
  for (var _i13 = 0, _Object$keys4 = Object.keys(types); _i13 < _Object$keys4.length; _i13++) {
    var _type3 = _Object$keys4[_i13];
...
function parseStringPromisified(input) {
  return new Promise(function (resolve, reject) {
    (0, _xml2js.parseString)(input, function (error, result) {
      if (error) {
        return reject(error);
      }
