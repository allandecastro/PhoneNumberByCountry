...
exports.ValidateManifestTask = exports.ValidateSourceTask = void 0;
...
class ValidateSourceTask {
    ...
    run(context) {
        return context.mapControls((control) => {
            ...
            if (!sourceCodeValidator_1.ValidateCode(context.getDiagnostic(), codePath, control.getControlName())) {
